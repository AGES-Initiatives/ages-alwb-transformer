 ...
 * @version 1.0
 * 
 * @see PdfBuilder#xmlTransformer(String, String, String)
 * @see PdfBuilder#foToPdf()
 *
 */
public class PdfBuilder {
	 ...
	 * after instantiation.
	 * 
	 * @see PdfBuilder#setXmlSourceFileName
	 * @see PdfBuilder#setOutputDirectory
	 * @see PdfBuilder#setDeleteIntermediateFiles
	 */
	public PdfBuilder(
...
//		 System.out.println(outputDirectory);
	...
	public void foToPdf() {
		...
		try {
			...
			File outFile = new File(pdfOutputPath+pdfOutputFile);
...
//		}
	...
	public static void main(String[] args) {
		String foSource = "../net.ages.liturgical.workbench.templates/src-gen/website";
		boolean deleteFoFiles = false;
		boolean createMonthlyEpubs = true;
		...
		if (hadErrors) {
			System.out.println("Could not make PDFs because could not find fo files in ");
